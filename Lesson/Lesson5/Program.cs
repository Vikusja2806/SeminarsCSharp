...
ShowArray(myArray);
Console.WriteLine(FindNumberArray(myArray, number));
*/
/*
...
Console.Write("Input мин число отрезка: ");
int c = Convert.ToInt32(Console.ReadLine());
Console.Write("Input max число отрезка: ");
int d = Convert.ToInt32(Console.ReadLine());

int [] myArray = CreateRandomArray(size, min, max);

ShowArray(myArray);
int result = CountElements(myArray, c, d);
Console.WriteLine($"Количество элементов массива, находящихся в заданном отрезка равно {result} ");
*/
/*
